...
<div id="wrapper">
    <div class="main-content_signup">
        ...
        <div class="l-part">
                <form:form action="${pageContext.request.contextPath}/add/user" modelAttribute="userDto" enctype="multipart/form-data">
                ...
                <form:input path="username" type="text" placeholder="Username" class="input-1" />
                <div class="overlap-text">
                    <form:input path="password" type="password" placeholder="Password" class="input-2" />
                </div>
                    <div class="overlap-text">
